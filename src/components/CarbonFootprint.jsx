...
const CarbonFootprint = () => {
  ...
  function showText(event, index){
    const clickedElement = event.target;
    const pTaginsideLi = clickedElement.querySelector('p');
    pTaginsideLi.classList.toggle('li-text-inactive')

    let updatedclickedList = [...clicked];
    updatedclickedList[index] = !updatedclickedList[index]
    isClicked(updatedclickedList);
  }
  ...
  return (
    <main className="CarbonFootprint">
      ...
      <section className='introduccion-carbono'>
        ...
        <ul>
          <li onClick={(event) => showText(event, 0)} className={`li-carbon ${ clicked[0] ? 'active' : ''}`}>¿Qué es una compensación de carbono? 
          ...
          <li onClick={(event) => showText(event, 1)} className={`li-carbon ${ clicked[1] ? 'active' : ''}`}>¿Como se generan las compensaciones de carbono?
          ...
          <li onClick={(event) => showText(event, 2)} className={`li-carbon ${ clicked[2] ? 'active' : ''}`}>¿Que tipo de empresas están comprando las compensanciones de carbono?
            <p className='li-text li-text-inactive'>
          ...
          <li onClick={(event) => showText(event, 3)} className={`li-carbon ${ clicked[3] ? 'active' : ''}`}>¿Cómo se verfican las compensancioones?
          ...
          <li onClick={(event) => showText(event, 4)} className={`li-carbon ${ clicked[4] ? 'active' : ''}`}>
